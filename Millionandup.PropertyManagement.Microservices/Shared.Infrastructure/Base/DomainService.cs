...
{
    /// <summary>
    /// Clase base para servicios de dominios
    /// </summary>
    public abstract class DomainService : IDomainService
    {
        ...
        public void SetContext(DbContext context)
        {
            ...
            var members = GetType().GetFields(System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
                .Where(f => typeof(IRepository).
                IsAssignableFrom(f.FieldType) || typeof(IDomainService)
                .IsAssignableFrom(f.FieldType)).ToList();
